...
for ROLE in roles/run.admin roles/cloudbuild.builds.editor roles/iam.serviceAccountUser roles/storage.admin roles/serviceusage.serviceUsageAdmin roles/artifactregistry.admin roles/browser; do
